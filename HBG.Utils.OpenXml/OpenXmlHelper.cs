// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OpenXmlHelper.cs" company="HBG">
//   HBG.OpenXml.ExcelHelper
// </copyright>
// <summary>
//   The open xml helper.
// </summary>
// 【v1.0.1.20160414】 修复大于26列时的Bug
// --------------------------------------------------------------------------------------------------------------------
...
namespace HBG.Utils.OpenXml
{
    ...
    public static class ExcelHelper
    {
        ...
        /// The <see cref="Row"/>.
        /// </returns>
        public static Row GetRow(this SheetData sheetData, long rowIndex)
        {
        ...
        /// The <see cref="Cell"/>.
        /// </returns>
        public static Cell GetCell(this Row row, string cellName)
        {
